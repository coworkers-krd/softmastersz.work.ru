					...
					<div class="magazine__block magazine__block--books">
						...
						<div class="magazine__books-item">
							<div class="magazine__img-wrapper">
								<img src="http://www.fillmurray.com/240/390" alt="" class="magazine__img">
							</div>
							<p class="magazine__text">Симонята – рай на земле</p>
							<p class="magazine__subtext">Книга, 2015 год</p>
							<a href="#" class="magazine__btn">Читать</a>
						</div>
						<div class="magazine__books-item">
							<div class="magazine__img-wrapper">
								<img src="http://www.fillmurray.com/240/390" alt="" class="magazine__img">
							</div>
							<p class="magazine__text">Журналистика третьей провинции</p>
							<p class="magazine__subtext">Книга, 2015 год</p>
							<a href="#" class="magazine__btn">Читать</a>
						</div>
						<div class="magazine__books-item">
